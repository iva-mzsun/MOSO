...
class VideoDiffFramesDataset_EXT_FirstFrame(Dataset):
    ...
    def __getitem__(self, index):
        ...
        first_img = get_img_from_path(os.path.join(cur_path, files[start + 1]),
                                    transform=self.transform)
        ...
        for file in files[start + 2: start + 2 + self.num_frames]:
            ...
            cur_diff = cur_img * 2 - first_img - nxt_img
