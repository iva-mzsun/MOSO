...
class Generator_woCONFI(object):
...
class Generator_mo_woCONFI(object):
    def __init__(self, num_frames, gen_opt, init_tokens, start_step, tot_steps, mask_token_id, gamma_function):
        ...
        for i in range(T):
            ...
            cur_generator = Generator_woCONFI(gen_opt, cur_init_tokens, start_step, tot_steps, mask_token_id, gamma_function)
